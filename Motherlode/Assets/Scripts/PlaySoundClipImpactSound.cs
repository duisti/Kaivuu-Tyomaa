...
public class PlaySoundClipImpactSound : MonoBehaviour {
	...
	public void PlaySound() {
		...
		MasterAudioSummoner.instance.PlayAudio(MasterAudioSummoner.instance.ImpactSounds, random, volume, 0.03f, transform.position, null);
	}
}
